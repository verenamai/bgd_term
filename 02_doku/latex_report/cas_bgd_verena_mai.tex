...
\usepackage[english,ngerman]{babel}										% english hyphenation
%\usepackage[latin1]{inputenc}  							% Unix/Linux - load extended character set (ISO 8859-1)
\usepackage[ansinew]{inputenc}  							% Windows - load extended character set (ISO 8859-1)
\usepackage[T1]{fontenc}											% hyphenation of words with ä,ö and ü
\usepackage{textcomp}													% additional symbols
\usepackage{listings}\usepackage{ae}																% better resolution of Type1-Fonts 
...
\include{chapters/data_preperation}
%\include{chapters/model_building}
%\include{chapters/model_evaluation}
%\include{chapters/model_deployment}
...
\cleardoublepage
\phantomsection 
\addcontentsline{toc}{chapter}{Selbst{\"a}ndigkeitserkl{\"a}rung}
